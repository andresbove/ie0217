...
public:
    ...
    Matriz<T> operator*(const Matriz<T>& otra) const {
        if (columnas != otra.filas) {
            throw std::invalid_argument("El número de columnas de la matriz A debe ser igual al número de filas de la matriz B para la multiplicación.");
        }
...
public:
    static void validarSumaResta(const Matriz<T>& a, const Matriz<T>& b) {
        if (a.filas != b.filas || a.columnas != b.columnas) {
            throw std::invalid_argument("Las dimensiones de las matrices no son compatibles para la operación.");
        }
    }
...
void mostrarMenu() {
    ...
    std::cout << "3. Ejecutar operación" << std::endl;
    ...
    while (!salir) {
        ...
        switch (opcion) {
            case 1:
                ...
                std::cout << "Opción 1: Ingresar matrices.\n";
                // Aquí puedes llamar a una función para ingresar matrices
                break;
            
            case 2:
                // Lógica para mostrar matrices.
                std::cout << "Opción 2: Mostrar matrices.\n";
                // Aquí puedes llamar a una función para mostrar las matrices
                break;

            case 3:
                // Lógica para ejecutar operación.
                std::cout << "Opción 3: Ejecutar operación.\n";
                // Aquí puedes llamar a una función para ejecutar la operación seleccionada
                break;

            case 4:
                // Lógica para generar datos aleatorios.
                std::cout << "Opción 4: Generar datos aleatorios.\n";
                // Aquí puedes llamar a una función para generar datos aleatorios
                break;

            case 5:
                // Opción para finalizar el programa.
                std::cout << "Opción 5: Finalizar programa.\n";
                salir = true;
                break;
